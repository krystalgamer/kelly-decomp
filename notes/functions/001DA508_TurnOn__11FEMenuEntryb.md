...
The target and released configuration reduce FEMenuEntry::TurnOn(bool) to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
