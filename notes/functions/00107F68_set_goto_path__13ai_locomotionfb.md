# set_goto_path__13ai_locomotionfb
...
Read the released clear_path call, target position, set_path virtual slot, use flag, and retry counter. It matched on attempt 1.
