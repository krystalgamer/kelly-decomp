...
Deferred text_widget RTTI generation after five source-level attempts; the released widget inheritance and generated RTTI calls reproduced, but the target global-address register allocation did not.
