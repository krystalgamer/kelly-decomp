...
The target and released configuration reduce MenuEntry::OnTick(float) to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
