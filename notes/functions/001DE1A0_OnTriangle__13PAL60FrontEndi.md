...
The target and released configuration reduce PAL60FrontEnd::OnTriangle(int) to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
