...
Read the released 50-track clear loop, Track layout, empty strings, invalid source ID, and totalSources reset. The exact source body matched on attempt 1.
