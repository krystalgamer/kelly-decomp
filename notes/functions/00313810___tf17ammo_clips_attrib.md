...
Deferred ammo_clips_attrib RTTI generation after five source-level attempts; the released bounded_attribute<int> inheritance and generated RTTI calls reproduced, but the target global-address register allocation did not.
