...
Deferred code_callback RTTI generation after five source-level attempts; the released signal_callback inheritance and generated RTTI calls reproduced, but the target global-address register allocation did not.
