...
Deferred cg_mesh RTTI generation after five source-level attempts; the released collision_geometry inheritance and generated RTTI calls reproduced, but the target global-address register allocation did not.
