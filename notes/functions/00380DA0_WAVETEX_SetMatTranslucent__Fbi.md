# WAVETEX_SetMatTranslucent__Fbi
...
Deferred the released wave-material translucency toggle after five source-level attempts; the bit update was exact semantically, but target pointer arithmetic register allocation could not be reproduced.
