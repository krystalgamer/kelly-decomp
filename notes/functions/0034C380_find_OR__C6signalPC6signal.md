...
| ---: | --- | ---: | ---: | --- |
| 1 | different | 34.7561 | 2.439 | `candidate.cpp` |
...
Five released signal-list variants reproduced OR lookup but not iterator spill scheduling.
