# pop_disable_all__12ai_interfaceb
...
Deferred AI disable-all pop after five source-level attempts; the released interface-list traversal and cosmetic filtering reproduced, but the target STL iterator stack layout did not.
