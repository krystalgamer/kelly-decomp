...
- Debug source: `C:/KS/SRC/time_interface.h`
- Reference source: `KS/SRC/time_interface.h`
- Result: **matched**
...
The released time-interface destructor matched exactly on the first attempt.
