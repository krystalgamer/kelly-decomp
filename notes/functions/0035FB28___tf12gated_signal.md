...
Deferred gated_signal RTTI generation after five source-level attempts; the released signal inheritance and generated RTTI calls reproduced, but the target global-address register allocation did not.
