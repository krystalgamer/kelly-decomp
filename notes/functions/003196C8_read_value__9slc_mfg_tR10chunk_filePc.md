# read_value__9slc_mfg_tR10chunk_filePc
...
Deferred the released MFG script-value reader after five source-level attempts; the exact string lifecycle and virtual lookup body remained blocked by prologue scheduling differences.
