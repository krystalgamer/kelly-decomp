...
The target and released configuration reduce init_fast_sin_table() to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
