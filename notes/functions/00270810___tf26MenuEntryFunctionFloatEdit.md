# __tf26MenuEntryFunctionFloatEdit
...
Five source-faithful nested RTTI variants reproduced the MenuEntryFunctionFloatEdit RTTI hierarchy but not original saved-register scheduling.
