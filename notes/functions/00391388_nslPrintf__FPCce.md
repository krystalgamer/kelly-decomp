...
Five released-source variadic reconstructions reproduced formatting, callback dispatch, and fallback output, but the original mixed GPR/FPR va_list save prologue could not be reproduced.
