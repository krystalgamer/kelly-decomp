...
The target and released configuration reduce os_alloc_init() to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
