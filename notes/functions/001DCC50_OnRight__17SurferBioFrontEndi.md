...
The target and released configuration reduce SurferBioFrontEnd::OnRight(int) to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
