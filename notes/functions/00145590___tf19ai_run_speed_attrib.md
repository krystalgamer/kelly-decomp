...
Deferred ai_run_speed_attrib RTTI generation after five source-level attempts; the released base/derived records and RTTI calls reproduced, but the target global-address register allocation did not.
