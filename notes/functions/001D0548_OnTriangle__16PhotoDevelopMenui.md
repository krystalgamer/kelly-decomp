# OnTriangle__16PhotoDevelopMenui
...
The target and released configuration reduce PhotoDevelopMenu::OnTriangle(int) to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
