...
The target and released configuration reduce FEMenu::OnR1(int) to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
