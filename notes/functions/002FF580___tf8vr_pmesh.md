...
Deferred vr_pmesh RTTI generation after five source-level attempts; the released visual_rep inheritance and generated RTTI calls reproduced, but the target global-address register allocation did not.
