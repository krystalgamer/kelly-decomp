...
Deferred water_object RTTI generation after five source-level attempts; the released beach_object inheritance and generated RTTI calls reproduced, but the target global-address register allocation did not.
