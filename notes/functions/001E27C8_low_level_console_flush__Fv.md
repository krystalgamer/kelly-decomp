...
The target and released configuration reduce low_level_console_flush() to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
