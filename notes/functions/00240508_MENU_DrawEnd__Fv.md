...
The target and released configuration reduce MENU_DrawEnd() to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
