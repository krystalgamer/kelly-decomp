# __dl__t11linear_anim1Z8vector3dPv
...
Deferred linear_anim<vector3d> pool operator delete after five source-level attempts; the released null guard, pool scan, occupancy clear, and failure print reproduced, but the target loop load and branch-likely schedule did not.
