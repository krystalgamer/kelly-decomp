...
The released ten-slot animation-array check uses the shared entity layout. A
local `memset` pointer preserves the normal call.

## Outcome

The compiler barrier was removed; the released setup remains exact.
