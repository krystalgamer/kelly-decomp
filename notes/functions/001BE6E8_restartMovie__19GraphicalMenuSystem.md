# restartMovie__19GraphicalMenuSystem
...
The target and released configuration reduce GraphicalMenuSystem::restartMovie() to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
