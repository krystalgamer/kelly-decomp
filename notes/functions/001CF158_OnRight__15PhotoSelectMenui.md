...
Deferred PhotoSelectMenu::OnRight after five source-level attempts; the released base-right dispatch, sound sequence, arrow highlight index, and timer reproduced at 90%, but the target callee-save prologue scheduling did not.
