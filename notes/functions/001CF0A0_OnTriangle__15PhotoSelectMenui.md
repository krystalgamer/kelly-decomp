# OnTriangle__15PhotoSelectMenui
...
The target and released configuration reduce PhotoSelectMenu::OnTriangle(int) to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
