...
Deferred HeatMidMenuClass RTTI generation after five source-level attempts; the released FEMenu inheritance and generated RTTI calls reproduced, but the target global-address register allocation did not.
