...
Deferred text_element RTTI generation after five source-level attempts; the released element inheritance and generated RTTI calls reproduced, but the target global-address register allocation did not.
