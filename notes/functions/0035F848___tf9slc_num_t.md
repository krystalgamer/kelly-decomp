...
Deferred slc_num_t RTTI generation after five source-level attempts; the released script_library_class inheritance and generated RTTI calls reproduced, but the target global-address register allocation did not.
