# Despawn__Q213IconChallenge8Sequence
...
Read the exact released Sequence/Task declarations, 16-byte Task stride, numTasks layout, and Despawn loop. It matched on attempt 1.
