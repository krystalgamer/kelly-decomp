...
Deferred the released scalar linear-animation static allocator after five source-level attempts; the pool scan, slot bookkeeping, 16-byte indexing, and exhaustion path were reconstructed, but loop reload scheduling remained different.
