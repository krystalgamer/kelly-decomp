...
Deferred the released variadic fatal-error wrapper after five source-level attempts; the stripped compiler environment could not reproduce the original mixed-register va_start save area and frame layout.
