...
Deferred entity_anim pool operator delete after five source-level attempts; the released null guard, pool scan, occupancy clear, and failure print reproduced at 90%, but the target global register and add scheduling did not.
