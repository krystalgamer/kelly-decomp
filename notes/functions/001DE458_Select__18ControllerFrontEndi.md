...
The target and released configuration reduce ControllerFrontEnd::Select(int) to an empty hook. The first candidate matched exactly and preserved the byte-identical integrated ROM.
