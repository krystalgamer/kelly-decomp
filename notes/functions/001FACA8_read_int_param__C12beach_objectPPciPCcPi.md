# read_int_param__C12beach_objectPPciPCcPi
...
Five released integer parameter-reader variants reproduced parsing but not GCC2 loop-bound prologue scheduling.
