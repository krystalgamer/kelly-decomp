...
Used the exact released MainFrontEnd::OnUp body, including its redundant nested MainFreeEntry test. EE GCC merged all three virtual dispatches and tail-called playEvent, producing 196 bytes.
