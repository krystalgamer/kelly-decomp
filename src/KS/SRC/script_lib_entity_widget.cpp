...
extern "C" void **RttiBase_00327408()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00327408[]
    __asm__("__ti30slf_entity_widget_get_entity_t");
extern "C" const char rtti_name_00327408[];
extern "C" void *rtti_base_type_00327408[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti30slf_entity_widget_get_entity_t, 0x005A4A00");
__asm__(".equ rtti_name_00327408, 0x0050F620");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00327408() __asm__("__tf30slf_entity_widget_get_entity_t");

void **Rtti_00327408()
{
    if (!rtti_type_00327408[0]) {
        RttiBase_00327408();
        __rtti_si(rtti_type_00327408, rtti_name_00327408, rtti_base_type_00327408);
    }
    return rtti_type_00327408;
}
#endif
