...
extern "C" void **RttiBase_00324D90()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00324D90[]
    __asm__("__ti15slf_anim_play_t");
extern "C" const char rtti_name_00324D90[];
extern "C" void *rtti_base_type_00324D90[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti15slf_anim_play_t, 0x005A47E0");
__asm__(".equ rtti_name_00324D90, 0x0050F250");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00324D90() __asm__("__tf15slf_anim_play_t");

void **Rtti_00324D90()
{
    if (!rtti_type_00324D90[0]) {
        RttiBase_00324D90();
        __rtti_si(rtti_type_00324D90, rtti_name_00324D90, rtti_base_type_00324D90);
    }
...
extern "C" void **RttiBase_00324E58()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00324E58[]
    __asm__("__ti24slf_anim_wait_finished_t");
extern "C" const char rtti_name_00324E58[];
extern "C" void *rtti_base_type_00324E58[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti24slf_anim_wait_finished_t, 0x005A47F0");
__asm__(".equ rtti_name_00324E58, 0x0050F268");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00324E58() __asm__("__tf24slf_anim_wait_finished_t");

void **Rtti_00324E58()
{
    if (!rtti_type_00324E58[0]) {
        RttiBase_00324E58();
        __rtti_si(rtti_type_00324E58, rtti_name_00324E58, rtti_base_type_00324E58);
    }
...
extern "C" void **RttiBase_00324F90()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00324F90[]
    __asm__("__ti20slf_anim_kill_anim_t");
extern "C" const char rtti_name_00324F90[];
extern "C" void *rtti_base_type_00324F90[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti20slf_anim_kill_anim_t, 0x005A4800");
__asm__(".equ rtti_name_00324F90, 0x0050F288");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00324F90() __asm__("__tf20slf_anim_kill_anim_t");

void **Rtti_00324F90()
{
    if (!rtti_type_00324F90[0]) {
        RttiBase_00324F90();
        __rtti_si(rtti_type_00324F90, rtti_name_00324F90, rtti_base_type_00324F90);
    }
...
extern "C" void **RttiBase_00325038()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00325038[]
    __asm__("__ti15slf_load_anim_t");
extern "C" const char rtti_name_00325038[];
extern "C" void *rtti_base_type_00325038[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti15slf_load_anim_t, 0x005A4810");
__asm__(".equ rtti_name_00325038, 0x0050F2A0");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00325038() __asm__("__tf15slf_load_anim_t");

void **Rtti_00325038()
{
    if (!rtti_type_00325038[0]) {
        RttiBase_00325038();
        __rtti_si(rtti_type_00325038, rtti_name_00325038, rtti_base_type_00325038);
    }
