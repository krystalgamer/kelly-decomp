...
// 0x00310B88 fill_n__H3ZPcZUiZc_X01X11RCX21_X01
extern "C" char *fill_values(
    char *first,
    unsigned int count,
    const char &value
) __asm__("fill_n__H3ZPcZUiZc_X01X11RCX21_X01");

char *fill_values(char *first, unsigned int count, const char &value)
{
