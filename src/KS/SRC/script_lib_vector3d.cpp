...
extern "C" void **RttiBase_0032AAD0()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_0032AAD0[]
    __asm__("__ti10slf_dot3_t");
extern "C" const char rtti_name_0032AAD0[];
extern "C" void *rtti_base_type_0032AAD0[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti10slf_dot3_t, 0x005A4C30");
__asm__(".equ rtti_name_0032AAD0, 0x0050FA38");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_0032AAD0() __asm__("__tf10slf_dot3_t");

void **Rtti_0032AAD0()
{
    if (!rtti_type_0032AAD0[0]) {
        RttiBase_0032AAD0();
        __rtti_si(rtti_type_0032AAD0, rtti_name_0032AAD0, rtti_base_type_0032AAD0);
    }
    return rtti_type_0032AAD0;
}
#endif
...
extern "C" void **RttiBase_0032ACC0()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_0032ACC0[]
    __asm__("__ti12slf_cross3_t");
extern "C" const char rtti_name_0032ACC0[];
extern "C" void *rtti_base_type_0032ACC0[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti12slf_cross3_t, 0x005A4C40");
__asm__(".equ rtti_name_0032ACC0, 0x0050FA48");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_0032ACC0() __asm__("__tf12slf_cross3_t");

void **Rtti_0032ACC0()
{
    if (!rtti_type_0032ACC0[0]) {
        RttiBase_0032ACC0();
        __rtti_si(rtti_type_0032ACC0, rtti_name_0032ACC0, rtti_base_type_0032ACC0);
    }
    return rtti_type_0032ACC0;
}
#endif
...
extern "C" void **RttiBase_0032AED8()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_0032AED8[]
    __asm__("__ti13slf_normal3_t");
extern "C" const char rtti_name_0032AED8[];
extern "C" void *rtti_base_type_0032AED8[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti13slf_normal3_t, 0x005A4C50");
__asm__(".equ rtti_name_0032AED8, 0x0050FA58");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_0032AED8() __asm__("__tf13slf_normal3_t");

void **Rtti_0032AED8()
{
    if (!rtti_type_0032AED8[0]) {
        RttiBase_0032AED8();
        __rtti_si(rtti_type_0032AED8, rtti_name_0032AED8, rtti_base_type_0032AED8);
    }
...
extern "C" void **RttiBase_0032B360()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_0032B360[]
    __asm__("__ti20slf_angle_between3_t");
extern "C" const char rtti_name_0032B360[];
extern "C" void *rtti_base_type_0032B360[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti20slf_angle_between3_t, 0x005A4C70");
__asm__(".equ rtti_name_0032B360, 0x0050FA80");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_0032B360() __asm__("__tf20slf_angle_between3_t");

void **Rtti_0032B360()
{
    if (!rtti_type_0032B360[0]) {
        RttiBase_0032B360();
        __rtti_si(rtti_type_0032B360, rtti_name_0032B360, rtti_base_type_0032B360);
    }
    return rtti_type_0032B360;
}
#endif
