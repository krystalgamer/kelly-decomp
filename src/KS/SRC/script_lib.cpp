...
extern "C" void *disable_marky_cam_base_type[] __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti23slf_disable_marky_cam_t, 0x005A42A0");
__asm__(".equ disable_marky_cam_name, 0x0050E948");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **DisableMarkyCamRtti() __asm__("__tf23slf_disable_marky_cam_t");
void **DisableMarkyCamRtti()
{
    if (!disable_marky_cam_type[0]) {
        DisableMarkyCamBaseRtti();
        __rtti_si(disable_marky_cam_type, disable_marky_cam_name, disable_marky_cam_base_type);
    }
    return disable_marky_cam_type;
}
#endif
...
extern "C" void *localize_thread_base_type[] __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti21slf_localize_thread_t, 0x005A42D0");
__asm__(".equ localize_thread_name, 0x0050E998");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **LocalizeThreadRtti() __asm__("__tf21slf_localize_thread_t");
void **LocalizeThreadRtti()
{
    if (!localize_thread_type[0]) {
        LocalizeThreadBaseRtti();
        __rtti_si(localize_thread_type, localize_thread_name, localize_thread_base_type);
    }
    return localize_thread_type;
}
#endif
...
extern "C" void *globalize_thread_base_type[] __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti22slf_globalize_thread_t, 0x005A4300");
__asm__(".equ globalize_thread_name, 0x0050E9F8");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **GlobalizeThreadRtti() __asm__("__tf22slf_globalize_thread_t");
void **GlobalizeThreadRtti()
{
    if (!globalize_thread_type[0]) {
        GlobalizeThreadBaseRtti();
        __rtti_si(globalize_thread_type, globalize_thread_name, globalize_thread_base_type);
    }
    return globalize_thread_type;
}
#endif
...
extern "C" void *suspend_all_ai_base_type[] __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti20slf_suspend_all_ai_t, 0x005A4310");
__asm__(".equ suspend_all_ai_name, 0x0050EA18");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **SuspendAllAiRtti() __asm__("__tf20slf_suspend_all_ai_t");
void **SuspendAllAiRtti()
{
    if (!suspend_all_ai_type[0]) {
        SuspendAllAiBaseRtti();
        __rtti_si(suspend_all_ai_type, suspend_all_ai_name, suspend_all_ai_base_type);
    }
    return suspend_all_ai_type;
}
#endif
...
extern "C" void *wait_animate_fog_distance_base_type[] __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti31slf_wait_animate_fog_distance_t, 0x005A4360");
__asm__(".equ wait_animate_fog_distance_name, 0x0050EAA8");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **WaitAnimateFogDistanceRtti() __asm__("__tf31slf_wait_animate_fog_distance_t");
void **WaitAnimateFogDistanceRtti()
{
    if (!wait_animate_fog_distance_type[0]) {
        WaitAnimateFogDistanceBaseRtti();
        __rtti_si(wait_animate_fog_distance_type, wait_animate_fog_distance_name,
                  wait_animate_fog_distance_base_type);
    }
    return wait_animate_fog_distance_type;
}
#endif
...
extern "C" void *dilated_delay_base_type[] __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti19slf_dilated_delay_t, 0x005A43B0");
__asm__(".equ dilated_delay_name, 0x0050EB38");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **DilatedDelayRtti() __asm__("__tf19slf_dilated_delay_t");
void **DilatedDelayRtti()
{
    if (!dilated_delay_type[0]) {
        DilatedDelayBaseRtti();
        __rtti_si(dilated_delay_type, dilated_delay_name, dilated_delay_base_type);
    }
    return dilated_delay_type;
}
#endif
...
extern "C" void *post_message_base_type[] __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti18slf_post_message_t, 0x005A43F0");
__asm__(".equ post_message_name, 0x0050EB98");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **PostMessageRtti() __asm__("__tf18slf_post_message_t");
void **PostMessageRtti()
{
    if (!post_message_type[0]) {
        PostMessageBaseRtti();
        __rtti_si(post_message_type, post_message_name, post_message_base_type);
    }
    return post_message_type;
}
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031DBE0(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031DC80(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031DD50(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031DE20(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031DEE8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031DF98(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031E060(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031E0E8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031E1D0(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031E270(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031E300(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031E390(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031E480(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031E570(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031E800(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031E980(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031EB20(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031EB98(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031EC60(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031ED70(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031EE48(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031EF18(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031EFD8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031F060(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031F0E8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031F2C8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031F4C0(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031F6A0(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031F728(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031F7B0(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031F970(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031FB70(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031FDC8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_0031FF88(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00320140(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_003201B8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00320230(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_003202B8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00320330(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_003203A8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_003205F0(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00320698(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00320858(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00320A50(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00320C48(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00320E40(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00321020(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00321200(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_003212C8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_003213A8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_003215C0(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif
...
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00321848(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00321AC0)
// 0x00321AC0 _$_16slf_to_str_num_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00321AC0(void *self) __asm__("_$_16slf_to_str_num_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00321AC0(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00321CE0)
// 0x00321CE0 _$_16slf_to_str_int_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
...
// 0x00321F08 _$_22slf_add_3d_debug_str_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
...
// 0x00322008 _$_22slf_add_2d_debug_str_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
...
// 0x00322108 _$_15slf_bsp_check_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
...
// 0x00322450 _$_27slf_get_bsp_check_hit_pos_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
...
// 0x00322628 _$_28slf_get_bsp_check_hit_norm_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
...
// 0x00322800 _$_27slf_get_bsp_check_hit_ent_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
...
// 0x003229C0 _$_22slf_entity_col_check_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
...
// 0x00322BD0 _$_20slf_play_sound_vol_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
...
#if defined(KELLY_DECOMP_FUNCTION_00322E30)
// 0x00322E30 _$_30slf_set_global_time_dilation_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00322E30(void *self) __asm__("_$_30slf_set_global_time_dilation_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
...
#if defined(KELLY_DECOMP_FUNCTION_00323030)
// 0x00323030 _$_16slf_load_level_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00323030(void *self) __asm__("_$_16slf_load_level_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00323030(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_003230D8)
// 0x003230D8 _$_16slf_play_movie_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_003230D8(void *self) __asm__("_$_16slf_play_movie_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_003230D8(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00323190)
// 0x00323190 _$_23slf_set_game_info_num_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00323190(void *self) __asm__("_$_23slf_set_game_info_num_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00323190(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00323258)
// 0x00323258 _$_23slf_get_game_info_num_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00323258(void *self) __asm__("_$_23slf_get_game_info_num_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00323258(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00323448)
// 0x00323448 _$_23slf_set_game_info_str_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00323448(void *self) __asm__("_$_23slf_set_game_info_str_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00323448(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00323510)
// 0x00323510 _$_23slf_get_game_info_str_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00323510(void *self) __asm__("_$_23slf_get_game_info_str_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00323510(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00323718)
// 0x00323718 _$_19slf_wait_fps_test_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00323718(void *self) __asm__("_$_19slf_wait_fps_test_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00323718(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00323958)
// 0x00323958 _$_21slf_freeze_universe_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00323958(void *self) __asm__("_$_21slf_freeze_universe_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00323958(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_003239E0)
// 0x003239E0 _$_19slf_get_fog_color_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_003239E0(void *self) __asm__("_$_19slf_get_fog_color_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
...
#if defined(KELLY_DECOMP_FUNCTION_00323FA0)
// 0x00323FA0 _$_17slf_systime_day_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00323FA0(void *self) __asm__("_$_17slf_systime_day_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00323FA0(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00324170)
// 0x00324170 _$_25slf_systime_day_of_week_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00324170(void *self) __asm__("_$_25slf_systime_day_of_week_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00324170(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00324340)
// 0x00324340 _$_18slf_systime_year_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00324340(void *self) __asm__("_$_18slf_systime_year_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00324340(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_00324510)
// 0x00324510 _$_18slf_systime_hour_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_00324510(void *self) __asm__("_$_18slf_systime_hour_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_00324510(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_003246E0)
// 0x003246E0 _$_20slf_systime_minute_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_003246E0(void *self) __asm__("_$_20slf_systime_minute_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
void ScriptDtor_003246E0(void *self) { ScriptFunctionDtor(self); KELLY_DECOMP_COMPILER_BARRIER(); }
#endif

#if defined(KELLY_DECOMP_FUNCTION_003248B0)
// 0x003248B0 _$_20slf_systime_second_t
extern "C" void ScriptFunctionDtor(void *self) __asm__("_$_Q220script_library_class8function");
extern "C" void ScriptDtor_003248B0(void *self) __asm__("_$_20slf_systime_second_t");
__asm__(".equ _$_Q220script_library_class8function, 0x0034F178");
...
extern "C" void **LetterboxCoutBaseRtti()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *letterbox_cout_type[]
    __asm__("__ti20slf_letterbox_cout_t");
extern "C" const char letterbox_cout_name[];
extern "C" void *letterbox_cout_base_type[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti20slf_letterbox_cout_t, 0x005A44C0");
__asm__(".equ letterbox_cout_name, 0x0050ECE0");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **LetterboxCoutRtti() __asm__("__tf20slf_letterbox_cout_t");

void **LetterboxCoutRtti()
{
    if (!letterbox_cout_type[0]) {
        LetterboxCoutBaseRtti();
        __rtti_si(letterbox_cout_type, letterbox_cout_name, letterbox_cout_base_type);
    }
...
extern "C" void **WasAPressedBaseRtti()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *was_A_pressed_type[]
    __asm__("__ti19slf_was_A_pressed_t");
extern "C" const char was_A_pressed_name[];
extern "C" void *was_A_pressed_base_type[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti19slf_was_A_pressed_t, 0x005A4530");
__asm__(".equ was_A_pressed_name, 0x0050EDA0");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **WasAPressedRtti() __asm__("__tf19slf_was_A_pressed_t");

void **WasAPressedRtti()
{
    if (!was_A_pressed_type[0]) {
        WasAPressedBaseRtti();
        __rtti_si(was_A_pressed_type, was_A_pressed_name, was_A_pressed_base_type);
    }
...
extern "C" void **ToStrVector3dBaseRtti()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *to_str_vector3d_type[]
    __asm__("__ti21slf_to_str_vector3d_t");
extern "C" const char to_str_vector3d_name[];
extern "C" void *to_str_vector3d_base_type[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti21slf_to_str_vector3d_t, 0x005A45B0");
__asm__(".equ to_str_vector3d_name, 0x0050EE78");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **ToStrVector3dRtti() __asm__("__tf21slf_to_str_vector3d_t");

void **ToStrVector3dRtti()
{
    if (!to_str_vector3d_type[0]) {
        ToStrVector3dBaseRtti();
        __rtti_si(to_str_vector3d_type, to_str_vector3d_name, to_str_vector3d_base_type);
    }
...
extern "C" void **ToStrIntBaseRtti()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *to_str_int_type[]
    __asm__("__ti16slf_to_str_int_t");
extern "C" const char to_str_int_name[];
extern "C" void *to_str_int_base_type[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti16slf_to_str_int_t, 0x005A45D0");
__asm__(".equ to_str_int_name, 0x0050EEA8");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **ToStrIntRtti() __asm__("__tf16slf_to_str_int_t");

void **ToStrIntRtti()
{
    if (!to_str_int_type[0]) {
        ToStrIntBaseRtti();
        __rtti_si(to_str_int_type, to_str_int_name, to_str_int_base_type);
    }
    return to_str_int_type;
}
#endif
...
extern "C" void **Add3dDebugStrBaseRtti()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *add_3d_debug_str_type[]
    __asm__("__ti22slf_add_3d_debug_str_t");
extern "C" const char add_3d_debug_str_name[];
extern "C" void *add_3d_debug_str_base_type[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti22slf_add_3d_debug_str_t, 0x005A45E0");
__asm__(".equ add_3d_debug_str_name, 0x0050EEC0");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Add3dDebugStrRtti() __asm__("__tf22slf_add_3d_debug_str_t");

void **Add3dDebugStrRtti()
{
    if (!add_3d_debug_str_type[0]) {
        Add3dDebugStrBaseRtti();
        __rtti_si(add_3d_debug_str_type, add_3d_debug_str_name, add_3d_debug_str_base_type);
    }
...
extern "C" void **RttiBase_00322128()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00322128[]
    __asm__("__ti15slf_bsp_check_t");
extern "C" const char rtti_name_00322128[];
extern "C" void *rtti_base_type_00322128[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti15slf_bsp_check_t, 0x005A4600");
__asm__(".equ rtti_name_00322128, 0x0050EF00");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00322128() __asm__("__tf15slf_bsp_check_t");

void **Rtti_00322128()
{
    if (!rtti_type_00322128[0]) {
        RttiBase_00322128();
        __rtti_si(rtti_type_00322128, rtti_name_00322128, rtti_base_type_00322128);
    }
    return rtti_type_00322128;
}
#endif
...
extern "C" void **RttiBase_00322470()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00322470[]
    __asm__("__ti27slf_get_bsp_check_hit_pos_t");
extern "C" const char rtti_name_00322470[];
extern "C" void *rtti_base_type_00322470[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti27slf_get_bsp_check_hit_pos_t, 0x005A4610");
__asm__(".equ rtti_name_00322470, 0x0050EF18");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00322470() __asm__("__tf27slf_get_bsp_check_hit_pos_t");

void **Rtti_00322470()
{
    if (!rtti_type_00322470[0]) {
        RttiBase_00322470();
        __rtti_si(rtti_type_00322470, rtti_name_00322470, rtti_base_type_00322470);
    }
    return rtti_type_00322470;
}
#endif
...
extern "C" void **RttiBase_00322648()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00322648[]
    __asm__("__ti28slf_get_bsp_check_hit_norm_t");
extern "C" const char rtti_name_00322648[];
extern "C" void *rtti_base_type_00322648[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti28slf_get_bsp_check_hit_norm_t, 0x005A4620");
__asm__(".equ rtti_name_00322648, 0x0050EF38");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00322648() __asm__("__tf28slf_get_bsp_check_hit_norm_t");

void **Rtti_00322648()
{
    if (!rtti_type_00322648[0]) {
        RttiBase_00322648();
        __rtti_si(rtti_type_00322648, rtti_name_00322648, rtti_base_type_00322648);
    }
    return rtti_type_00322648;
}
#endif
...
extern "C" void **RttiBase_00322820()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00322820[]
    __asm__("__ti27slf_get_bsp_check_hit_ent_t");
extern "C" const char rtti_name_00322820[];
extern "C" void *rtti_base_type_00322820[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti27slf_get_bsp_check_hit_ent_t, 0x005A4630");
__asm__(".equ rtti_name_00322820, 0x0050EF58");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00322820() __asm__("__tf27slf_get_bsp_check_hit_ent_t");

void **Rtti_00322820()
{
    if (!rtti_type_00322820[0]) {
        RttiBase_00322820();
        __rtti_si(rtti_type_00322820, rtti_name_00322820, rtti_base_type_00322820);
    }
    return rtti_type_00322820;
}
#endif
...
extern "C" void **RttiBase_003229E0()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_003229E0[]
    __asm__("__ti22slf_entity_col_check_t");
extern "C" const char rtti_name_003229E0[];
extern "C" void *rtti_base_type_003229E0[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti22slf_entity_col_check_t, 0x005A4640");
__asm__(".equ rtti_name_003229E0, 0x0050EF78");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_003229E0() __asm__("__tf22slf_entity_col_check_t");

void **Rtti_003229E0()
{
    if (!rtti_type_003229E0[0]) {
        RttiBase_003229E0();
        __rtti_si(rtti_type_003229E0, rtti_name_003229E0, rtti_base_type_003229E0);
    }
    return rtti_type_003229E0;
}
#endif
...
extern "C" void **RttiBase_00322BF0()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00322BF0[]
    __asm__("__ti20slf_play_sound_vol_t");
extern "C" const char rtti_name_00322BF0[];
extern "C" void *rtti_base_type_00322BF0[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti20slf_play_sound_vol_t, 0x005A4650");
__asm__(".equ rtti_name_00322BF0, 0x0050EF98");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00322BF0() __asm__("__tf20slf_play_sound_vol_t");

void **Rtti_00322BF0()
{
    if (!rtti_type_00322BF0[0]) {
        RttiBase_00322BF0();
        __rtti_si(rtti_type_00322BF0, rtti_name_00322BF0, rtti_base_type_00322BF0);
    }
    return rtti_type_00322BF0;
}
#endif
...
extern "C" void **RttiBase_00322C90()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00322C90[]
    __asm__("__ti30slf_get_global_time_dilation_t");
extern "C" const char rtti_name_00322C90[];
extern "C" void *rtti_base_type_00322C90[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti30slf_get_global_time_dilation_t, 0x005A4660");
__asm__(".equ rtti_name_00322C90, 0x0050EFB0");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00322C90() __asm__("__tf30slf_get_global_time_dilation_t");

void **Rtti_00322C90()
{
    if (!rtti_type_00322C90[0]) {
        RttiBase_00322C90();
        __rtti_si(rtti_type_00322C90, rtti_name_00322C90, rtti_base_type_00322C90);
    }
    return rtti_type_00322C90;
}
#endif
...
extern "C" void **RttiBase_00322E50()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00322E50[]
    __asm__("__ti30slf_set_global_time_dilation_t");
extern "C" const char rtti_name_00322E50[];
extern "C" void *rtti_base_type_00322E50[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti30slf_set_global_time_dilation_t, 0x005A4670");
__asm__(".equ rtti_name_00322E50, 0x0050EFD8");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00322E50() __asm__("__tf30slf_set_global_time_dilation_t");

void **Rtti_00322E50()
{
    if (!rtti_type_00322E50[0]) {
        RttiBase_00322E50();
        __rtti_si(rtti_type_00322E50, rtti_name_00322E50, rtti_base_type_00322E50);
    }
...
extern "C" void **RttiBase_00323050()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00323050[]
    __asm__("__ti16slf_load_level_t");
extern "C" const char rtti_name_00323050[];
extern "C" void *rtti_base_type_00323050[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti16slf_load_level_t, 0x005A4690");
__asm__(".equ rtti_name_00323050, 0x0050F028");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00323050() __asm__("__tf16slf_load_level_t");

void **Rtti_00323050()
{
    if (!rtti_type_00323050[0]) {
        RttiBase_00323050();
        __rtti_si(rtti_type_00323050, rtti_name_00323050, rtti_base_type_00323050);
    }
    return rtti_type_00323050;
}
#endif
...
extern "C" void **RttiBase_003230F8()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_003230F8[]
    __asm__("__ti16slf_play_movie_t");
extern "C" const char rtti_name_003230F8[];
extern "C" void *rtti_base_type_003230F8[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti16slf_play_movie_t, 0x005A46A0");
__asm__(".equ rtti_name_003230F8, 0x0050F040");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_003230F8() __asm__("__tf16slf_play_movie_t");

void **Rtti_003230F8()
{
    if (!rtti_type_003230F8[0]) {
        RttiBase_003230F8();
        __rtti_si(rtti_type_003230F8, rtti_name_003230F8, rtti_base_type_003230F8);
    }
    return rtti_type_003230F8;
}
#endif
...
extern "C" void **RttiBase_003231B0()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_003231B0[]
    __asm__("__ti23slf_set_game_info_num_t");
extern "C" const char rtti_name_003231B0[];
extern "C" void *rtti_base_type_003231B0[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti23slf_set_game_info_num_t, 0x005A46B0");
__asm__(".equ rtti_name_003231B0, 0x0050F058");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_003231B0() __asm__("__tf23slf_set_game_info_num_t");

void **Rtti_003231B0()
{
    if (!rtti_type_003231B0[0]) {
        RttiBase_003231B0();
        __rtti_si(rtti_type_003231B0, rtti_name_003231B0, rtti_base_type_003231B0);
    }
...
extern "C" void **RttiBase_00323468()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00323468[]
    __asm__("__ti23slf_set_game_info_str_t");
extern "C" const char rtti_name_00323468[];
extern "C" void *rtti_base_type_00323468[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti23slf_set_game_info_str_t, 0x005A46D0");
__asm__(".equ rtti_name_00323468, 0x0050F098");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00323468() __asm__("__tf23slf_set_game_info_str_t");

void **Rtti_00323468()
{
    if (!rtti_type_00323468[0]) {
        RttiBase_00323468();
        __rtti_si(rtti_type_00323468, rtti_name_00323468, rtti_base_type_00323468);
    }
    return rtti_type_00323468;
}
#endif
...
extern "C" void **RttiBase_00323530()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00323530[]
    __asm__("__ti23slf_get_game_info_str_t");
extern "C" const char rtti_name_00323530[];
extern "C" void *rtti_base_type_00323530[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti23slf_get_game_info_str_t, 0x005A46E0");
__asm__(".equ rtti_name_00323530, 0x0050F0B8");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00323530() __asm__("__tf23slf_get_game_info_str_t");

void **Rtti_00323530()
{
    if (!rtti_type_00323530[0]) {
        RttiBase_00323530();
        __rtti_si(rtti_type_00323530, rtti_name_00323530, rtti_base_type_00323530);
    }
    return rtti_type_00323530;
}
#endif
...
extern "C" void **RttiBase_00323738()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00323738[]
    __asm__("__ti19slf_wait_fps_test_t");
extern "C" const char rtti_name_00323738[];
extern "C" void *rtti_base_type_00323738[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti19slf_wait_fps_test_t, 0x005A46F0");
__asm__(".equ rtti_name_00323738, 0x0050F0D8");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00323738() __asm__("__tf19slf_wait_fps_test_t");

void **Rtti_00323738()
{
    if (!rtti_type_00323738[0]) {
        RttiBase_00323738();
        __rtti_si(rtti_type_00323738, rtti_name_00323738, rtti_base_type_00323738);
    }
    return rtti_type_00323738;
}
#endif
...
extern "C" void **RttiBase_00323978()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00323978[]
    __asm__("__ti21slf_freeze_universe_t");
extern "C" const char rtti_name_00323978[];
extern "C" void *rtti_base_type_00323978[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti21slf_freeze_universe_t, 0x005A4700");
__asm__(".equ rtti_name_00323978, 0x0050F0F0");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00323978() __asm__("__tf21slf_freeze_universe_t");

void **Rtti_00323978()
{
    if (!rtti_type_00323978[0]) {
        RttiBase_00323978();
        __rtti_si(rtti_type_00323978, rtti_name_00323978, rtti_base_type_00323978);
    }
    return rtti_type_00323978;
}
#endif
...
extern "C" void **RttiBase_00323A00()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00323A00[]
    __asm__("__ti19slf_get_fog_color_t");
extern "C" const char rtti_name_00323A00[];
extern "C" void *rtti_base_type_00323A00[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti19slf_get_fog_color_t, 0x005A4710");
__asm__(".equ rtti_name_00323A00, 0x0050F108");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00323A00() __asm__("__tf19slf_get_fog_color_t");

void **Rtti_00323A00()
{
    if (!rtti_type_00323A00[0]) {
        RttiBase_00323A00();
        __rtti_si(rtti_type_00323A00, rtti_name_00323A00, rtti_base_type_00323A00);
    }
    return rtti_type_00323A00;
}
#endif
...
extern "C" void **RttiBase_00323C30()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00323C30[]
    __asm__("__ti22slf_get_fog_distance_t");
extern "C" const char rtti_name_00323C30[];
extern "C" void *rtti_base_type_00323C30[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti22slf_get_fog_distance_t, 0x005A4720");
__asm__(".equ rtti_name_00323C30, 0x0050F120");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00323C30() __asm__("__tf22slf_get_fog_distance_t");

void **Rtti_00323C30()
{
    if (!rtti_type_00323C30[0]) {
        RttiBase_00323C30();
        __rtti_si(rtti_type_00323C30, rtti_name_00323C30, rtti_base_type_00323C30);
    }
    return rtti_type_00323C30;
}
#endif
...
extern "C" void **RttiBase_00323DF0()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00323DF0[]
    __asm__("__ti19slf_systime_month_t");
extern "C" const char rtti_name_00323DF0[];
extern "C" void *rtti_base_type_00323DF0[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti19slf_systime_month_t, 0x005A4730");
__asm__(".equ rtti_name_00323DF0, 0x0050F140");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00323DF0() __asm__("__tf19slf_systime_month_t");

void **Rtti_00323DF0()
{
    if (!rtti_type_00323DF0[0]) {
        RttiBase_00323DF0();
        __rtti_si(rtti_type_00323DF0, rtti_name_00323DF0, rtti_base_type_00323DF0);
    }
    return rtti_type_00323DF0;
}
#endif
...
extern "C" void **RttiBase_00323FC0()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00323FC0[]
    __asm__("__ti17slf_systime_day_t");
extern "C" const char rtti_name_00323FC0[];
extern "C" void *rtti_base_type_00323FC0[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti17slf_systime_day_t, 0x005A4740");
__asm__(".equ rtti_name_00323FC0, 0x0050F158");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00323FC0() __asm__("__tf17slf_systime_day_t");

void **Rtti_00323FC0()
{
    if (!rtti_type_00323FC0[0]) {
        RttiBase_00323FC0();
        __rtti_si(rtti_type_00323FC0, rtti_name_00323FC0, rtti_base_type_00323FC0);
    }
    return rtti_type_00323FC0;
}
#endif
...
extern "C" void **RttiBase_00324190()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00324190[]
    __asm__("__ti25slf_systime_day_of_week_t");
extern "C" const char rtti_name_00324190[];
extern "C" void *rtti_base_type_00324190[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti25slf_systime_day_of_week_t, 0x005A4750");
__asm__(".equ rtti_name_00324190, 0x0050F170");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00324190() __asm__("__tf25slf_systime_day_of_week_t");

void **Rtti_00324190()
{
    if (!rtti_type_00324190[0]) {
        RttiBase_00324190();
        __rtti_si(rtti_type_00324190, rtti_name_00324190, rtti_base_type_00324190);
    }
    return rtti_type_00324190;
}
#endif
...
extern "C" void **RttiBase_00324360()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00324360[]
    __asm__("__ti18slf_systime_year_t");
extern "C" const char rtti_name_00324360[];
extern "C" void *rtti_base_type_00324360[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti18slf_systime_year_t, 0x005A4760");
__asm__(".equ rtti_name_00324360, 0x0050F190");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00324360() __asm__("__tf18slf_systime_year_t");

void **Rtti_00324360()
{
    if (!rtti_type_00324360[0]) {
        RttiBase_00324360();
        __rtti_si(rtti_type_00324360, rtti_name_00324360, rtti_base_type_00324360);
    }
    return rtti_type_00324360;
}
#endif
...
extern "C" void **RttiBase_00324530()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00324530[]
    __asm__("__ti18slf_systime_hour_t");
extern "C" const char rtti_name_00324530[];
extern "C" void *rtti_base_type_00324530[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti18slf_systime_hour_t, 0x005A4770");
__asm__(".equ rtti_name_00324530, 0x0050F1A8");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00324530() __asm__("__tf18slf_systime_hour_t");

void **Rtti_00324530()
{
    if (!rtti_type_00324530[0]) {
        RttiBase_00324530();
        __rtti_si(rtti_type_00324530, rtti_name_00324530, rtti_base_type_00324530);
    }
    return rtti_type_00324530;
}
#endif
...
extern "C" void **RttiBase_00324700()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_00324700[]
    __asm__("__ti20slf_systime_minute_t");
extern "C" const char rtti_name_00324700[];
extern "C" void *rtti_base_type_00324700[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti20slf_systime_minute_t, 0x005A4780");
__asm__(".equ rtti_name_00324700, 0x0050F1C0");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_00324700() __asm__("__tf20slf_systime_minute_t");

void **Rtti_00324700()
{
    if (!rtti_type_00324700[0]) {
        RttiBase_00324700();
        __rtti_si(rtti_type_00324700, rtti_name_00324700, rtti_base_type_00324700);
    }
    return rtti_type_00324700;
}
#endif
...
extern "C" void **RttiBase_003248D0()
    __asm__("__tfQ220script_library_class8function");
extern "C" void *rtti_type_003248D0[]
    __asm__("__ti20slf_systime_second_t");
extern "C" const char rtti_name_003248D0[];
extern "C" void *rtti_base_type_003248D0[]
    __asm__("__tiQ220script_library_class8function");
__asm__(".equ __tfQ220script_library_class8function, 0x0035F640");
__asm__(".equ __ti20slf_systime_second_t, 0x005A4790");
__asm__(".equ rtti_name_003248D0, 0x0050F1D8");
__asm__(".equ __tiQ220script_library_class8function, 0x005121B8");
extern "C" void **Rtti_003248D0() __asm__("__tf20slf_systime_second_t");

void **Rtti_003248D0()
{
    if (!rtti_type_003248D0[0]) {
        RttiBase_003248D0();
        __rtti_si(rtti_type_003248D0, rtti_name_003248D0, rtti_base_type_003248D0);
    }
...
#if defined(KELLY_DECOMP_FUNCTION_00321F78)
// 0x00321F78 __cl__22slf_add_3d_debug_str_tR8vm_stackQ320script_library_class8function7entry_t
struct vector3d{float x,y,z;};struct stringx{};struct vm_stack{char p[8];char*sp;};struct parms_t{vector3d pos;vector3d col;float dur;stringx*s1;};extern "C" void add(const vector3d&,unsigned,float,const stringx&)__asm__("add_3d_text__FRC8vector3dG7color32fRC7stringx");__asm__(".equ add_3d_text__FRC8vector3dG7color32fRC7stringx,0x002C9798");extern "C" bool call(void*,vm_stack&,int)__asm__("__cl__22slf_add_3d_debug_str_tR8vm_stackQ320script_library_class8function7entry_t");bool call(void*,vm_stack&stack,int){stack.sp-=32;parms_t*parms=(parms_t*)stack.sp;unsigned char color[4];float cr=parms->col.x;float cg=parms->col.y;float cb=parms->col.z;color[3]=255;int r=((int)(cr*255.0f))&255;int g=((int)(cg*255.0f))&255;int b=(int)(cb*255.0f);color[2]=r;color[0]=b;color[1]=g;add(parms->pos,*(unsigned*)color,parms->dur,*parms->s1);return true;}
#endif

#if defined(KELLY_DECOMP_FUNCTION_00322078)
// 0x00322078 __cl__22slf_add_2d_debug_str_tR8vm_stackQ320script_library_class8function7entry_t
struct vector3d{float x,y,z;};struct stringx{};struct vm_stack{char p[8];char*sp;};struct parms_t{vector3d pos;vector3d col;float dur;stringx*s1;};extern "C" void add(const vector3d&,unsigned,float,const stringx&)__asm__("add_2d_text__FRC8vector3dG7color32fRC7stringx");__asm__(".equ add_2d_text__FRC8vector3dG7color32fRC7stringx,0x002C9A78");extern "C" bool call(void*,vm_stack&,int)__asm__("__cl__22slf_add_2d_debug_str_tR8vm_stackQ320script_library_class8function7entry_t");bool call(void*,vm_stack&stack,int){stack.sp-=32;parms_t*parms=(parms_t*)stack.sp;unsigned char color[4];float cr=parms->col.x;float cg=parms->col.y;float cb=parms->col.z;color[3]=255;int r=((int)(cr*255.0f))&255;int g=((int)(cg*255.0f))&255;int b=(int)(cb*255.0f);color[2]=r;color[0]=b;color[1]=g;add(parms->pos,*(unsigned*)color,parms->dur,*parms->s1);return true;}
#endif

#if defined(KELLY_DECOMP_FUNCTION_0031ECD0)
// 0x0031ECD0 __cl__15slf_abs_delay_tR8vm_stackQ320script_library_class8function7entry_t
extern unsigned long long current_clock;asm(".equ current_clock,0x0040E498");asm(".equ __floatdisf,0x003CB008");struct vm_stack{char p[8];char*sp;};struct Clock{unsigned start;void reset(){start=(unsigned)current_clock;}float elapsed()const{unsigned long long delta=current_clock-(unsigned long long)start;return(float)delta*0.0001f;}};struct Parms{float duration;};extern "C" bool call_fn(void*,vm_stack&,int) __asm__("__cl__15slf_abs_delay_tR8vm_stackQ320script_library_class8function7entry_t");bool call_fn(void*,vm_stack&stack,int entry){Clock*sdata=(Clock*)stack.sp;stack.sp-=4;Parms*parms=(Parms*)stack.sp;if(entry==0){sdata->reset();return false;}else{return sdata->elapsed()>=parms->duration;}}
#endif
