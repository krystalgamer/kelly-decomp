...
__asm__(".equ remove__t4list2ZP12typeface_defZt12my_allocator1ZP12typeface_defRCP12typeface_def, 0x003584E0");
__asm__(".equ _$_12typeface_def, 0x0033C5D0");

void typeface_close(typeface_def *typeface)
{
    if (!typeface->usercount) {
        typeface_list.remove(typeface);
        delete typeface;
    }
}
